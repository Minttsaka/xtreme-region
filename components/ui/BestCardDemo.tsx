      ...
      <div className="flex flex-row flex-shrink-0 justify-center items-center gap-2">
        ...
        <Container className="circle-3">
          ...
          <Image
            ...
            height="50"
            width="50"
            className=" md:w-full rounded-3xl  md:h-full"
          />
        </Container>
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "max-w-sm w-full mx-auto p-8 rounded-xl  dark:bg-[rgba(40,40,40,0.70)] bg-transparent shadow-[2px_4px_16px_0px_rgba(248,248,678,0.06)_inset] group",
        className
      )}
    >
      {children}
...
const Container = ({
  ...
  return (
    <div
      className={cn(
        `h-full w-full rounded-xl flex items-center justify-center bg-[rgba(248,248,248,0.01)]
